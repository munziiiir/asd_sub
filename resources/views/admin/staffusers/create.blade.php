<x-admin.layout title="Add Staff User">
    ...
    <div class="card bg-base-200 shadow">
        <div class="card-body space-y-4">
            <h1 class="card-title">Add staff user</h1>
            <form method="POST" action="{{ route('admin.staffusers.store') }}" class="space-y-4">
                @csrf
