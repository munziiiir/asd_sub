<x-admin.layout title="Add Hotel">
    ...
    <div class="card bg-base-200 shadow">
        <div class="card-body space-y-4">
            ...
            <form method="POST" action="{{ route('admin.hotels.store') }}" class="space-y-4">
                @csrf
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input id="code" name="code" type="text" value="{{ old('code') }}" required class="input input-bordered w-full">
                        @error('code')
                            <p class="mt-1 text-sm text-error">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                @php
                    $oldCountryCode = old('country_code');
                @endphp
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <livewire:inputs.searchable-select
                            wire:key="country-select-create"
                    ...
                    <div class="space-y-2">
                        ...
                        <div data-role="timezone-select">
                            <livewire:inputs.searchable-select
                                wire:key="timezone-select-create"
                                input-name="timezone_id"
                                :value="old('timezone_id')"
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        // initialize constraints if old value present
